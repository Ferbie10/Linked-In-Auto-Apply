...
class EasyApplyLinkedin:
    ...
    def job_search(self):
        ...
        job_link = self.driver.get(
            'https://www.linkedin.com/jobs/search/' + easy_apply + '&keywords=' + self.keywords + '&location=' + self.location)

    def login_linkedin(self):

        login = self.driver.find_element(By.CSS_SELECTOR, ".nav__button-secondary")
        login.click()
        time.sleep(1)
...
if __name__ == '__main__':
    os.chdir(r'Enter the path to the folder')
